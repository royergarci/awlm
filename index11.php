					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options='{"delay": 9000, "gridwidth": 800, "gridheight": 700}'>
						<ul>
							<li data-transition="fade">
								<img src="imgn/slider/slider_1.jpg"  
									alt=""
								...
								<div class="tp-caption top-label"
									...
									data-start="500"
									style="z-index: 5"
									data-transform_in="y:[-300%];opacity:0;s:500;">AIR ACONDITIONATING</div>
								...
								<div class="tp-caption main-label"
									...
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;">AMERICAN WHITE LINE</div>
								...
								<div class="tp-caption bottom-label"
									...
									data-start="2000"
									style="z-index: 5"
									data-transform_in="y:[100%];opacity:0;s:500;">Instalación, Mantenimiento y Venta</div>
								...
								<a class="tp-caption btn btn-lg btn-primary btn-slider-action"
									...
									data-transform_out="opacity:0;s:500;"
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;">Información</a>
				...
				<div class="home-intro" id="home-intro">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-8">
								<p>
									Todas las marcas a toda la <em>Republica</em>
									<span>Servicio express los 365 días del año</span>
								</p>
							</div>
							<div class="col-md-4">
								<div class="mt-lg mb-xl">
									<a href="#demos" data-hash class="btn btn-primary mr-md appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="300">VER SERVICIOS</a> <span class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="600">o <a href="http://themeforest.net/item/porto-responsive-html5-template/4106987">CONTACTANOS</span></a>
								</div>
							</div>
						</div>
